...
router.post('/signUp', celebrate_1.celebrate({ body: Validation_1.NewUserSchema }), function (req, res, next) { return __awaiter(_this, void 0, void 0, function () {
...
router.post('/login', auth_1.requireAuth, celebrate_1.celebrate({ body: Validation_1.ExistingUserSchema }), function (req, res, next) { return __awaiter(_this, void 0, void 0, function () {
...
router.get('/verify', celebrate_1.celebrate({ query: Validation_1.TokenSchema }), function (req, res, next) { return __awaiter(_this, void 0, void 0, function () {
