...
router.post('/result', auth_1.requireAuth, celebrate_1.celebrate({ body: Validation_1.TestResultSchema }), function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                return [4 /*yield*/, tracker_1.default.processTestResult(req.body)];
            case 1:
                response = _a.sent();
                if (response.success)
...
router.post('/', auth_1.requireAuth, celebrate_1.celebrate({ body: Validation_1.NewClusterSchema }), function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
