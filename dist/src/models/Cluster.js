...
module.exports.createRecord = function (data) { return __awaiter(_this, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                new_record = new Cluster(__assign({}, data, { createdAt: Date.now() }));
...
module.exports.readRecord = function (options, pagination) { return __awaiter(_this, void 0, void 0, function () {
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, Cluster.find(__assign({}, ModelHelper_1.processAlternatives(options), { is_active: true }), null, pagination)];
            case 1: return [2 /*return*/, _a.sent()];
        }
    });
}); };
