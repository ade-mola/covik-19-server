            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        userData = this.userControl.jsonize(user.payload);
                        return [4 /*yield*/, this.userControl.update({ user_id: userId }, __assign(__assign({}, userData), { notification_token: notificationToken }))];
