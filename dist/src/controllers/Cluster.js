...
var ClusterModel = __importStar(require("../models/Cluster"));
var Response_1 = __importDefault(require("../utilities/Response"));
var ClusterController = /** @class */ (function (_super) {
    __extends(ClusterController, _super);
    function ClusterController() {
        var _this = _super.call(this) || this;
        _this.model = ClusterModel;
        return _this;
    }
    ClusterController.prototype.create = function (data) {
    ...
    ClusterController.prototype.readOne = function (options) {
        return __awaiter(this, void 0, void 0, function () {
            var record;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        record = _a.sent();
                        if (record[0])
                            return [2 /*return*/, Response_1.default.processSuccessfulResponse(record['0'])];
                        return [2 /*return*/, Response_1.default.processFailedResponse(404, 'Resource not found')];
                }
            });
        });
    };
    ClusterController.prototype.readMany = function (options, page, population) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        records = _a.sent();
                        if (records.length)
                            return [2 /*return*/, Response_1.default.processSuccessfulResponse(__spreadArrays(records))];
                        return [2 /*return*/, Response_1.default.processFailedResponse(404, 'Resource not found')];
                }
            });
        });
    };
    ClusterController.prototype.update = function (options, data) {
        return __awaiter(this, void 0, void 0, function () {
            var result;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        if (result && result.nModified)
                            return [2 /*return*/, Response_1.default.processSuccessfulResponse(__assign(__assign({}, options), data))];
                        if (result && !result.nModified)
    ...
    ClusterController.prototype.delete = function (options) {
        return __awaiter(this, void 0, void 0, function () {
            var result;
            return __generator(this, function (_a) {
                switch (_a.label) {
...
exports.default = new ClusterController;
